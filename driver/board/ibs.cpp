...
namespace mainunit::driver
{
   ...
   CUnitInputGetIbsTemperature::CUnitInputGetIbsTemperature() {}
   ...
   CUnitInputGetIbsVoltage::CUnitInputGetIbsVoltage() {}
   ...
   CUnitInputGetIbsCurrent::CUnitInputGetIbsCurrent() {}
   ...
   CUnitInputGetIbsCapacity::CUnitInputGetIbsCapacity() {}
   ...
   CUnitInputGetIbsCharge::CUnitInputGetIbsCharge() {}
   ...
   CUnitInputGetIbsHealth::CUnitInputGetIbsHealth() {}
